...
def create_split(
    ...
    # Guardado
    torch.save(dataset_train, out_dir / "train_dataset384.pt")
    torch.save(dataset_val,   out_dir / "val_dataset384.pt")
    torch.save(dataset_test,  out_dir / "test_dataset384.pt")
