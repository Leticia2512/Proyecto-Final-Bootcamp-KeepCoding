#!/usr/bin/env python3
"""
Genera un índice FAISS por dolencia (DMAE, Catarata, Retinopatía, Miopía)
a partir de los .txt en Fixed_david. Los guarda en vectorstores/david/.
"""
...
def main():
    ...
    fixed_dir = base_dir / "Fixed_david"
    out_dir = base_dir / "vectorstores" / "david"
    ...
    for disease, files in groups.items():
        print(f"\n▶️ Procesando grupo: {disease.upper()}")
        all_chunks = []
        for fname in files:
