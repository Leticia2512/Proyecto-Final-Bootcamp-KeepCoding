# Entrenamiento Top-5 clases a resolución 384×384 con ResNet34 + OneCycleLR + EMA
...
# ============= CONFIG (Run D - 384px) =============
BATCH_SIZE = 16          # 384px -> más VRAM. Sube si te cabe (24/32)
EPOCHS = 35
...
# Datasets 384px (ya creados por ti)
...
def main():
    ...
    print(
        f"[Top5-384] num_classes={num_classes}, meta_dim={meta_dim}, kept={KEEP_CLASSES}")
    ...
    # MLflow
    init_mlflow()
    run_name = "runD_resnet34_top5_384_onecycle_" + \
    ...
    with mlflow.start_run(run_name=run_name):
        ...
        ckpt_path = Path("checkpoints/best_runD_top5_384.pt")
        ...
        for epoch in range(1, EPOCHS + 1):
            ...
            val_out = evaluate(ema_model, val_loader, criterion,
                               device, class_names, prefix="val_top5_384")
        ...
        test_out = evaluate(ema_model, test_loader, criterion,
                            device, class_names, prefix="test_top5_384")
        print(
