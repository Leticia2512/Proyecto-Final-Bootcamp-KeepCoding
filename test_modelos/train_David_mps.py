...
class MultiModalNet(nn.Module):
    def __init__(self, n_features=6, n_classes=4, activation_function=nn.LeakyReLU, dropout_p=0.3):
        ...
        # Rama de imágenes (conv simple desde cero)
...
def main():
    ...
    with mlflow.start_run(run_name=run_name):
        ...
        best_acc = -1.0
        ckpt_path = Path("checkpoints/best_david_custom_mps.pt")
