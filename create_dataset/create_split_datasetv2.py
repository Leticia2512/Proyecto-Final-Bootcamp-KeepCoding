...
from eye_pytorch_datasetv2 import EyeDataset, get_train_transform, get_eval_transform
import numpy as np
import pandas as pd
...
def create_split(
    ...
    # Guardado
    torch.save(dataset_train, out_dir / "train_datasetv2.pt")
    torch.save(dataset_val,   out_dir / "val_datasetv2.pt")
    torch.save(dataset_test,  out_dir / "test_datasetv2.pt")
